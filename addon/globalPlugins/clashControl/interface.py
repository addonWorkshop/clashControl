...
class ClashControlSettingsPanel(ConfigBoundSettingsPanel):
    ...
    def makeSettings(self, settings_sizer):
        ...
        clash_base_url_field = sizer.addLabeledControl(
            _("Clash server base url"), wx.TextCtrl
        )
        self.clash_base_url_field = bind_with_config(
            clash_base_url_field, "clash_base_url"
        )
        ...
        clash_modes_field = sizer.addLabeledControl(
            _("Clash modes (comma separated)"), wx.TextCtrl
        )
